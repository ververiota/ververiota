...
module.exports.onLoad = async function () {
  ...
  if (!existsSync(resolve(__dirname, 'cache', 'rankcard4.png'))) await downloadFile("https://i.ibb.co/cT01wgS/received-673902617305112.png", resolve(__dirname, 'cache', 'rankcard4.png'));
  if (!existsSync(resolve(__dirname, 'cache', 'rankcard5.png'))) await downloadFile("https://i.ibb.co/PGfSVFB/received-1563590327353867.png", resolve(__dirname, 'cache', 'rankcard5.png'));
  if (!existsSync(resolve(__dirname, 'cache', 'rankcard6.png'))) await downloadFile("https://i.ibb.co/JcJg560/received-471986644596866.png", resolve(__dirname, 'cache','rankcard6.png'));
  if (!existsSync(resolve(__dirname, 'cache', 'rankcard7.png'))) await downloadFile("https://i.ibb.co/MDtN93H/received-442422670879978.png", resolve(__dirname, 'cache','rankcard7.png'));
  if (!existsSync(resolve(__dirname, 'cache', 'rankcard8.png'))) await downloadFile("https://i.ibb.co/rywksL7/received-967172967566753.png", resolve(__dirname, 'cache','rankcard8.png'));
...
//random rankcard by Siêu Đáng Yêu ,png by ngô đức hiển(xin vui lòng giữ credit)
	...
	let avatar = await request.get(`https://graph.facebook.com/${id}/picture?height=720&width=720&access_token=1073911769817594|aa417da57f9e260d1ac1ec4530b417de`);
