...
module.exports.run = async ({ api, event, args, Users }) => {
    ...
    switch (args[0]) {
        ...
        case '-i': {
            ...
            return api.sendMessage({body:"👤Người nuôi pokemon:" + name + "\n🔍ID: " + ID + "\n⏳Số pokemon: " + pet + "\n🛍Túi thức ăn: " + foods + "\n✅Số trận thắng: " + win + "\n❎Số trận thua: " + lose + "\n\n👉Thả cảm xúc '👍' vào để xem pokemon hiện có.", attachment: createReadStream(__dirname + "/cache/bantaixiu/274297685_2158259004350383_5647311325695705236_n.gif")},threadID,async  (error, info) => { 
        ...
        default: { 
            return api.sendMessage({body:"[====[POKEMON]====]\n👉Đăng kí: register/-r\n👉List pokemon: list/-l\n👉Info user: info/-i\n👉Cửa hàng: shop/-s\n👉Ba lô: bag/-b\n👉Tìm kiếm: search/find/-f\n👉Đấu trường: solo -c/-j/-e\n👉Hỗ trợ, giftcode: support",attachment: createReadStream(__dirname + "/cache/250716204_585879029326521_1030409883912714463_n.jpg")},  threadID, messageID)
        };
    }
}
